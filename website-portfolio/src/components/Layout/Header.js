...
const Header = ({ siteTitle }) => (
	<section className="hero is-medium pattern-cross-dots-lg maya-blue">
        ...
        <div className="content">
          ...
          <h3 className="subtitle is-3">and I am a web designer &amp; developer</h3>
        </div>
        <div className="buttons my-5">
          <button className="button is-primary">Contact me</button>
          <button className="button is-link is-light"><FaGithub /></button>
          <button className="button is-link is-light"><FaLinkedin /></button>
        </div>
			</div>
		</div>
	</section>
